...
const Portfolio = () => {
    return (
        ...
        <div className="services-wrapper">
            ...
            title="Master Thesis"
            description="Title: 'Flat-tax and minimum income experiment in an OLG model of Italy'. Published in Universidade Catolica Portuguesa repository."
            edescription="This paper aims to quantitatively analyze the impact of a pending fiscal reform in Italy (late 2019) for different cohort ages in an Overlapping Generation (OLG) model with permanent labour productivity across agents and a stochastic labour income component. Two Computational Experiments are conducted: the former involves a Mininmum Income scheme and a Flat-Tax only for the personal labour income, the latter the sets the marginal rate for personal labour and capital income."
            ...
            description="This website was created with React and Bootstrap v5.1." 
            edescription="analysis means a process of cleaning, transforming and modelin Data analysis means a process of cleaning, transforming and modelin"
            ...
            title="Web Scraper"
            description="H&M and Zara items scraper, built with Python Scrapy."
            />
        </div>
        </div>
    )

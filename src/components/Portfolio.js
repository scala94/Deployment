...
const Portfolio = () => {
    return (
        ...
        <div className="services-wrapper">
            ...
            edescription="As a good software developer I felt the exigence to create my personal portfolio website :). Well, here it is. Access the GitHub link below for the project."
            linkname="GitHub Link"
